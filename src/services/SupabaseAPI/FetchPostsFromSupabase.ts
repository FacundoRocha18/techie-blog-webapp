...
export const fetchPostsFromSupabase = async (): Promise<IPost[]> => {
  ...
  headers.append(
    'authorization',
    'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVhY2JicnlrZ2xzdGd3cmVjZmRlIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTY3NDE3MDU4NywiZXhwIjoxOTg5NzQ2NTg3fQ.kJeFN0A_dc2oA8L_wt3Qt9dyZyVtVo-ZyhnD6JKVOlE',
  )
